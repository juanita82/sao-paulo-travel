...
author: Ana I. Moreno-Monroy (Universitat Rovira i Virgili), Robin Lovelace (University of Leeds)  and Frederico R. Ramos (Fundação
  Getulio Vargas) 
output:
  pdf_document:
    keep_tex: yes
...
Table 1 shows the model split by type of secondary school student. (FOOTNOTE the source of this information is the 2007 Origin-Destination Household Travel Survey (O-D Survey), carried out by the São Paulo Metropolitan Transport Authority Mêtro. We focus on trips made by secondary school students with an indicated motive ``education'' at the destination. The total number of trips (excluding missing values) was 11,845. Of these, 5.5 percent were multimodal. In those cases, we assign the mode of the trip leg with the largest duration. We add all trip leg durations (in minutes) to obtain the total trip duration.) Clearly, secondary school students attending private schools disproportionally travel by car, compared to public school students (9% versus 47%), even though higher income areas are better served by public transport. This is in line with the findings of @de2015. Around 67% of public school students commute to school by active travel (mostly walking, since the percentage of biking is still relatively small), while 23% commute by public transport, which has much longer mean duration than other modes. 
...
The policy reduces further the accessibility level of areas in the first and second quantiles of accessibility. Areas in the first quantile experience an average reduction of 21% in school accessibility levels as a result of the changes in the spatial distribution of schools. In the mean time, areas that had high levels of accesibility to start with, experience an increase. The results suggest that concentrating the provision of public secondary schools accentuates the already large differences in accesibility levels across areas. 

# Conclusion and discussion

The policy experiment results suggest that a policy that concentrates the provision of public schools spatially is regressive, in the sense that teens living in areas that had the lowest levels of accessibility are the ones who experience the largest negative impact from the policy. They are likely to be worse off compared to an already difficult situation of low local schooling provision, low access by public transport and/or high competition by teens in other areas. In practice, such a change would probabily imply larger commuting times for students residing in areas with low accessibility, which can have further consequences in terms of attendance, drop-out likelihood and performance.  

Although the simulated scenario represents a rather extreme change in the distribution of public schooling, the way in which students with different levels of accessibility are impacted remains. In the absence of a public transport subsidy for school commutes, students that experience a significant increase in travel-to-school times may be force to change their commute mode from an active (and free of charge mode) to a paid-by mode, with the consequent increase in their monetary spent in commuting to school. The most negative effect is then felt by low-incomes students living in areas with low school accessibility, for whom the marginal increase in commuting costs represents a much larger share in their budget. 
...
Our study can be further extended to account for other modes of school commute, such as active travel. It can also benefit from a finer spatial dissagregation to capture within area inequalities, which may be substantial and are currently hidden away in area aggregates. A future extension of the index can incorporate a measure of school quality, which in so far assumed away. It will also be highly informative to calculate the proposed indices for other contexts and for different time periods in order to understand the true magnitude of the extent of inequality across individuals living in different areas of the SPMR. 

We conclude that extending the concept of local accessibility indicators to education can help to both contest and constructively tackle embedded social inequalities. Contestation can be seen as a powerful tool to prevent the implementation of regressive policies that threaten to accentuate already large disparities. Quantitative measures such as the ones proposed here help summarizing multiple dimensions of inequality into a single, intterpretable measure. Having this tool may be useful for both policy makers and social groups in discussing and negotiating policies with a highly sensitive social component and evident short and long-term consequences for those affected.   
