...
od_zone <- shapefile("/tmp/data/OD-2007/Mapas OD/ZONAS_od07.shp")
od_flow <- read.table("/tmp/Data/OD-2007/OD_2007.txt", sep=",")
...
summary(factor(od_flow$MOTIVO_D)) / nrow(od_flow) # % education -> 40%
sel_why <- od_flow$MOTIVO_D == 4
od_flow <- od_flow[sel_why,] # now 15,000 trips
