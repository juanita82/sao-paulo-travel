...
od_zone <- shapefile("D://data-2-irc/sao-paulo/Data/OD-2007/Mapas OD/ZONAS_od07.shp")
# od_flow <- read.table("C:/Users/juanita82/Dropbox/Robin-SaoPaulo/SaoPaulo/Data/OD-2007/OD_2007.txt", sep=",")
