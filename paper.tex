...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Ana I. Moreno-Monroy (Universitat Rovira i Virgili), Robin Lovelace (University of Leeds) and Frederico R. Ramos (Fundação Getulio Vargas)},
            pdftitle={The unequal distribution of access to education and transport: insights from the São Paulo Metropolitan Region},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\begin{figure}
\includegraphics[width=1\linewidth]{od-map} \caption{Visual representation of the 12,697 OD pairs routed through the Google Distance Matrix API on an interactive map in RStudio, an open source data analysis platform.}\label{fig:unnamed-chunk-4}
\end{figure}
\begin{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{cum_index} \caption{Cumulative opportunity index}\label{fig:unnamed-chunk-8}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{comp_index} \caption{Competitive accessibility index}\label{fig:unnamed-chunk-9}
\end{figure}
